...
//		builder = builder.paths(PathSelectors.ant("/rest/customers/**"));
		builder = builder.paths(PathSelectors.regex("/rest/customers/.*"));
...
//		return new Docket(DocumentationType.SWAGGER_2) // swagger 핵심 클래스
//				.select() // 문서 작성을 위한 내부 초기화 작업
//				// 문서를 만들 대상 컨트롤러가 있는 패키지 지정
...
//	}
	...
	private ApiInfo apiInfo() {
		...
		b = b.description("<h3>Customer</h3>Swagger를 이용한 Customer API<br>");
		b = b.version("3.0");
		ApiInfo ai = b.build();
		return ai;
	}
